...
if ( TRACE ) { TRACE( "Tile#OnTriggerEnter2D", this ); }
                ...
                if (!this._isMoving) {
                    ...
                    if (UnityEngine.Object.op_Implicit(tile) && !tile._isMoving && tile.layer > this.layer && !this.coverTiles.contains(tile)) {
